...
async function requestBinary(path: string): Promise<{ data: ArrayBuffer; contentType: string | null }> {
...
export const api = {
  ...
  generalSettings: (params: { page?: number; perPage?: number; search?: string } = {}) =>
    request<PaginatedResponse<unknown>>(
      `/general-settings${queryString({ page: params.page, per_page: params.perPage, search: params.search })}`
    ),

  createGeneralSetting: (payload: GeneralSettingPayload) =>
    request<{ data: unknown }>('/general-settings', {
      method: 'POST',
      body: generalSettingFormData(payload),
    }),

  updateGeneralSetting: (id: number, payload: GeneralSettingPayload) =>
    request<{ data: unknown }>(`/general-settings/${id}`, {
      method: 'POST',
      body: (() => {
        const formData = generalSettingFormData(payload);
  ...
  emailLogs: (params: { page?: number; perPage?: number; search?: string; status?: string; recordType?: string; from?: string; to?: string } = {}) =>
    request<PaginatedResponse<EmailLog>>(
  ...
  smsLogs: (params: { page?: number; perPage?: number; search?: string; status?: string; recordType?: string; from?: string; to?: string } = {}) =>
    request<PaginatedResponse<SmsLog>>(
      `/sms-logs${queryString({
        page: params.page,
        per_page: params.perPage,
        search: params.search,
        status: params.status,
  ...
  supplierStatement: (id: number, params: { page?: number; perPage?: number; from?: string; to?: string } = {}) =>
    request<PaginatedResponse<Payment>>(
      `/suppliers/${id}/statement${queryString({ page: params.page, per_page: params.perPage, from: params.from, to: params.to })}`
    ),
  ...
  expenseCategories: (params: { page?: number; perPage?: number; search?: string; activeOnly?: boolean } = {}) =>
    request<PaginatedResponse<unknown>>(
      `/expense-categories${queryString({ page: params.page, per_page: params.perPage, search: params.search, active_only: params.activeOnly })}`
    ),
  ...
  createExpense: (payload: ExpensePayload) =>
    request<{ data: Expense; message: string }>('/expenses', {
      method: 'POST',
      body: JSON.stringify(payload),
    }),

  updateExpense: (id: number, payload: ExpensePayload) =>
    request<{ data: Expense; message: string }>(`/expenses/${id}`, {
      method: 'PUT',
      body: JSON.stringify(payload),
    }),
  ...
  accountStatement: (id: number, params: { page?: number; perPage?: number; from?: string; to?: string } = {}) =>
    request<PaginatedResponse<Payment>>(
      `/accounts/${id}/statement${queryString({ page: params.page, per_page: params.perPage, from: params.from, to: params.to })}`
    ),
  ...
  customerStatement: (id: number, params: { page?: number; perPage?: number; from?: string; to?: string } = {}) =>
    request<PaginatedResponse<Payment>>(
      `/customers/${id}/statement${queryString({ page: params.page, per_page: params.perPage, from: params.from, to: params.to })}`
    ),
  ...
  datewiseProductReport: (params: { productId: number; startDate?: string; endDate?: string }) =>
    request<DatewiseProductReport>(
      `/reports/datewise-products${queryString({ product_id: params.productId, start_date: params.startDate, end_date: params.endDate })}`
    ),

  datewiseProductReportPdf: (params: { productId: number; startDate?: string; endDate?: string }) =>
    requestBinary(
  ...
  saleInvoiceOptions: (params: { search?: string; customerId?: number | null; perPage?: number; outstandingOnly?: boolean; approvedOnly?: boolean } = {}) =>
    request<PaginatedResponse<InvoiceOption>>(
      `/sales-invoices${queryString({ page: 1, per_page: params.perPage ?? 30, search: params.search, customer_id: params.customerId, outstanding_only: params.outstandingOnly, approved_only: params.approvedOnly })}`
    ),
  ...
  returnInvoiceOptions: (params: { search?: string; customerId?: number | null; perPage?: number; approvedOnly?: boolean } = {}) =>
    request<PaginatedResponse<InvoiceOption>>(
      `/return-invoices${queryString({ page: 1, per_page: params.perPage ?? 30, search: params.search, customer_id: params.customerId, approved_only: params.approvedOnly })}`
    ),

  returnInvoice: (id: number) => request<{ data: unknown }>(`/return-invoices/${id}`),

  createReturnInvoice: (payload: ReturnInvoicePayload) =>
    request<{ data: unknown; message: string }>('/return-invoices', {
      method: 'POST',
      body: returnInvoiceFormData(payload),
    }),

  updateReturnInvoice: (id: number, payload: ReturnInvoicePayload) =>
    request<{ data: unknown; message: string }>(`/return-invoices/${id}`, {
      method: 'POST',
      body: (() => {
        const formData = returnInvoiceFormData(payload);
        formData.append('_method', 'PUT');
        return formData;
      })(),
    }),
  ...
  purchaseInvoiceOptions: (params: { search?: string; supplierId?: number | null; perPage?: number; outstandingOnly?: boolean; approvedOnly?: boolean } = {}) =>
    request<PaginatedResponse<InvoiceOption>>(
      `/purchase-invoices${queryString({ page: 1, per_page: params.perPage ?? 30, search: params.search, supplier_id: params.supplierId, outstanding_only: params.outstandingOnly, approved_only: params.approvedOnly })}`
    ),
  ...
  purchaseReturnInvoiceOptions: (params: { search?: string; supplierId?: number | null; perPage?: number; approvedOnly?: boolean } = {}) =>
    request<PaginatedResponse<InvoiceOption>>(
      `/purchase-return-invoices${queryString({ page: 1, per_page: params.perPage ?? 30, search: params.search, supplier_id: params.supplierId, approved_only: params.approvedOnly })}`
    ),

  purchaseReturnInvoice: (id: number) => request<{ data: unknown }>(`/purchase-return-invoices/${id}`),

  createPurchaseReturnInvoice: (payload: PurchaseReturnPayload) =>
    request<{ data: unknown; message: string }>('/purchase-return-invoices', {
      method: 'POST',
      body: purchaseReturnFormData(payload),
    }),

  updatePurchaseReturnInvoice: (id: number, payload: PurchaseReturnPayload) =>
    request<{ data: unknown; message: string }>(`/purchase-return-invoices/${id}`, {
      method: 'POST',
      body: (() => {
        const formData = purchaseReturnFormData(payload);
        formData.append('_method', 'PUT');
        return formData;
      })(),
    }),
  ...
  createPayment: (payload: PaymentPayload) =>
    request<{ data: Payment; message: string }>('/payments', {
      method: 'POST',
      body: JSON.stringify(payload),
    }),
