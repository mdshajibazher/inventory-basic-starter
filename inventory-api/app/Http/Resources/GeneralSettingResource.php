...
class GeneralSettingResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'sales_invoice_approver_ids' => $this->sales_invoice_approver_ids ?? [],
            'return_invoice_approver_ids' => $this->return_invoice_approver_ids ?? [],
            'purchase_invoice_approver_ids' => $this->purchase_invoice_approver_ids ?? [],
            'payment_approver_ids' => $this->payment_approver_ids ?? [],
